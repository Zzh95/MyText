...
public class TabLayoutIndictor extends LinearLayout {
    ...
    public TabLayoutIndictor(Context context) {
        super(context);
    }
    public TabLayoutIndictor(Context context, AttributeSet attributeSet) {
    ...
    public void setViewPager(ViewPager mVpMain) {
